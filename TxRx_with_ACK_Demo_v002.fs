...
\
180 constant _maxMicrosecondsToWaitForAck
...
\
: repeatingTransmit CR 0 begin dup writeCounterToTxBuffer transmitTxBuffer waitForAck swap dup . ." transmitted..." swap if ." ACK received." ++value@2b else ."   Failed to receive ACK.  Retrying..." then CR again ;

: printReceivedPayload ." Payload received: " rxRadioBuffer var@2b . CR ;
